...
> | 📖 GitHub Wiki | [访问 GitHub Wiki](https://github.com/qq940500529/Artificial_Intelligence_Tutorial_zh/wiki) | **推荐阅读方式**：侧边栏导航 + 扁平化页面，适合逐课学习 |
> | 📖 Gitee Wiki | [访问 Gitee Wiki](https://gitee.com/LIGKNO1/Artificial_Intelligence_Tutorial_zh/wikis) | 国内访问 Wiki；内容与 GitHub Wiki 自动同步 |
>
...
上面的总览图只展示阶段与主题模块的推进关系。如需查看全部 **897 个知识点**及其层级与跨分支依赖，请使用交互式可视化页面：

👉 **[打开交互式知识图谱](https://qq940500529.github.io/Artificial_Intelligence_Tutorial_zh/)**（通过 GitHub Pages 部署，随仓库目录结构自动更新）

<details>
<summary>📝 交互式知识图谱使用说明</summary>

- 访问上方链接即可在浏览器中查看，无需安装任何软件
- 如需本地运行，克隆仓库后用浏览器打开 `知识图谱可视化/index.html` 即可
- 首页默认展示四大核心模块及其直接关系
